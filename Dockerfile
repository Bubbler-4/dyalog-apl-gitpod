...
RUN apt-get update -y -q \
  ...
  && cd /tmp \
  && curl -fsSL -k https://www.dyalog.com/uploads/php/download.dyalog.com/download.php?file=18.0/linux_64_18.0.39712_unicode.x86_64.deb -o dyalog.deb \
  && curl -fsSL -k https://github.com/Dyalog/ride/releases/download/v4.4.3495/ride-4.4.3495-1_amd64.deb -o ride.deb \
